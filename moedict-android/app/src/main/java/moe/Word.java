...
public final class Word extends Table {
  ...
  public Translation translation() { return translation(new Translation()); }
  public Translation translation(Translation obj) { int o = __offset(16); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
  ...
  public static int createWord(FlatBufferBuilder builder,
    ...
    Word.addTranslation(builder, translationOffset);
  ...
  public static void startWord(FlatBufferBuilder builder) { builder.startObject(7); }
  ...
  public static void addTranslation(FlatBufferBuilder builder, int translationOffset) { builder.addOffset(6, translationOffset, 0); }
