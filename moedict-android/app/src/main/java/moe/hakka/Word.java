...
public final class Word extends Table {
  ...
  public Heteronym heteronyms(Heteronym obj, int j) { int o = __offset(8); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int heteronymsLength() { int o = __offset(8); return o != 0 ? __vector_len(o) : 0; }
  ...
  public static void startWord(FlatBufferBuilder builder) { builder.startObject(3); }
  ...
  public static void addHeteronyms(FlatBufferBuilder builder, int heteronymsOffset) { builder.addOffset(2, heteronymsOffset, 0); }
