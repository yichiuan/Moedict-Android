...
namespace moe { namespace hakka {

using namespace std;
using namespace nlohmann;
using namespace flatbuffers;

void HakkaConverter::convert(const string& input, const string& output) {
    ifstream i(input);
    json j;
    i >> j;
...
Offset<Word> HakkaConverter::produce_word(const json& word, FlatBufferBuilder& builder) {
...
HakkaConverter::produce_heteronyms(const json& heteronyms, FlatBufferBuilder& builder) {
...
HakkaConverter::produce_definitions(const json& definitions, FlatBufferBuilder& builder) {
